...
export default function RecipeConsultant({ playAudio, stopAudio, isActive }) {
  ...
  const quickQuestions = ["Crear nueva receta", "Costo de platillos", "Ingredientes necesarios", "Análisis de costos"];
  ...
  return (
    <div className="space-y-4 h-full flex flex-col">
      ...
      <div className="flex gap-2 shrink-0">
        <Input placeholder="¿Qué necesitas con las recetas?" value={input}
